...
# Note: /refactor is a synonym for /chore and will be mapped to /chore internally
IssueClassSlashCommand = Literal["/chore", "/bug", "/feature", "/refactor"]

# Model set types for ADW workflows
ModelSet = Literal["base", "heavy"]

# Task complexity levels for timeout recommendations
class TaskComplexity(str, Enum):
    """Complexity levels for estimating workflow duration."""

    SIMPLE = "simple"        # Simple fixes, typos, documentation - ~5-10 minutes
    MEDIUM = "medium"        # Standard features, bug fixes - ~15-20 minutes
    COMPLEX = "complex"      # UI features, multiple files - ~25-35 minutes
    VERY_COMPLEX = "very_complex"  # Large refactoring, architecture changes - ~40-60 minutes
...
class ADWStateData(BaseModel):
    ...
    complexity: Optional[str] = None  # TaskComplexity: simple/medium/complex/very_complex
    recommended_timeout: Optional[int] = None  # Recommended timeout in seconds
